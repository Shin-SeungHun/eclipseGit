...
public class UserListController implements Initializable {
	...
	public void loadData() {
		...
		try {
			...
			boolean idOk = false;
			while (rs.next()) {
				String item = "id: "+rs.getString("id") + " / pw: " +rs.getString("pw")+" / 이름: " + rs.getString("name") + " / 닉네임: " + rs.getString("nickname")
						+ " / 나이: " + rs.getString("age") + " / 연락처: " + rs.getString("hp") + " / 성별: " + rs.getString("gender");
				list.add(item);
			}
			mList.setItems(list);
